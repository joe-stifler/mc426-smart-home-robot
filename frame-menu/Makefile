#############################################################################
# Makefile for building: bin/mc426-smart-home-robot
...
DIST          = shaders/* \
		...
		mc426-smart-home-robot.pro include/mainwindow.h \
		include/openglclass.h \
		include/stb_image.h src/main.cpp \
		src/mainwindow.cpp \
		src/openglclass.cpp
QMAKE_TARGET  = mc426-smart-home-robot
DESTDIR       = bin/
TARGET        = bin/mc426-smart-home-robot


first: all
####### Build rules

bin/mc426-smart-home-robot: uic/ui_mainwindow.h $(OBJECTS)  
...
all: Makefile bin/mc426-smart-home-robot
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/mainwindow.h include/openglclass.h include/stb_image.h $(DISTDIR)/
...
install_target: first FORCE
	...
	$(QINSTALL_PROGRAM) bin/$(QMAKE_TARGET) $(INSTALL_ROOT)/opt/mc426-smart-home-robot/bin/$(QMAKE_TARGET)
